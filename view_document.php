...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-md-12 mb-2">
			<button class="btn bg-light border float-right" type="button" id="share"><i class="fa fa-share"></i> Share This Malware</button>
		</div>
	</div>
    <?php endif; ?>
	<div class="row">
		...
		<div class="col-md-5">
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<div class="col-md-12">
						<div class="alert alert-info px-2 py-1"><i class="fa fa-info-circle"></i> Click the Malware to download.</div>
						<div class="row">
							 <?php
